...
function js_bangladesh_style() {
	...
	wp_enqueue_script( 'Customizar.js', get_template_directory_uri() . '/js/customizer.js', ['jquery'], time(), false );
	wp_enqueue_script( 'navigation.js', get_template_directory_uri() . '/js/navigation.js', ['jquery'], time(), false );
	wp_enqueue_script( 'popper.min.js', get_template_directory_uri() . '/js/popper.min.js', ['jquery'], time(), false );
	wp_enqueue_script( 'ajax-contact.js', get_template_directory_uri() . '/assets/js/ajax-contact.js', ['jquery'], time(), false );
	wp_enqueue_script( 'bootstrap.min.js', get_template_directory_uri() . '/assets/js/bootstrap.min.js', ['jquery'], time(), false );
	wp_enqueue_script( 'jquery-3.5.0.min.js', get_template_directory_uri() . '/assets/js/jquery-3.5.0.min.js', ['jquery'], time(), false );
	wp_enqueue_script( 'main.js', get_template_directory_uri() . '/assets/js/main.js', ['jquery'], time(), false );
	wp_enqueue_script( 'owl.carousel.min.js', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', ['jquery'], time(), false );
	wp_enqueue_script( 'popper.min.js', get_template_directory_uri() . '/assets/js/popper.min.js', ['jquery'], time(), false);
	wp_enqueue_script( 'switch.js', get_template_directory_uri() . '/assets/js/switch.js', ['jquery'], time(), false);
} 
